...
if __name__ == "__main__":
    ...
    parser_create.add_argument(
        ...
        type=str,
        nargs="+",
        help="name for IOC project, a list of name is supported.",
    )
    parser_create.add_argument(
        "-o",
        "--options",
    ...
    parser_create.add_argument(
        "--caputlog", action="store_true", help="add caPutLog module."
    )
    parser_create.add_argument(
        "--status-ioc",
        action="store_true",
    ...
    parser_create.add_argument(
        "--autosave", action="store_true", help="add autosave module."
    )
    parser_create.add_argument(
        "--add-asyn", action="store_true", help="add asyn template.\n"
    )
    parser_create.add_argument(
        "--add-stream", action="store_true", help="add StreamDevice template.\n"
    )
    parser_create.add_argument(
        "--add-raw",
        action="store_true",
    ...
    parser_list.add_argument(
        "-i", "--show-info", action="store_true", help="show details of IOC."
    )
    parser_list.add_argument(
        "-d", "--show-description", action="store_true", help="show description of IOC."
    )
    parser_list.add_argument(
        "-p", "--show-panel", action="store_true", help="show panel of all managed IOC."
    )
    parser_list.add_argument(
        "-v", "--verbose", action="store_true", help="show processing details."
    )
    ...
    parser_swarm.add_argument(
        "--show-tokens",
        action="store_true",
        help="show how to join into swarm for other nodes.",
    )
    parser_swarm.add_argument(
    ...
    parser_swarm.add_argument(
        "--backup-file", type=str, default="", help="tgz backup file for swarm."
    )
    parser_swarm.add_argument(
    ...
    parser_service.add_argument(
        "--deploy", action="store_true", help="deploy service into running."
    )
    parser_service.add_argument(
        "--type",
        type=str,
    ...
    parser_service.add_argument(
        "--remove", action="store_true", help="remove running service."
    )
    parser_service.add_argument(
        "--show-config",
        action="store_true",
    ...
    parser_service.add_argument(
        "--update", action="store_true", help="restart running service."
    )
    parser_service.add_argument(
        "-v", "--verbose", action="store_true", help="show processing details."
    )
    ...
    if args.func == "parse_create" or args.func == "parse_set":
        ...
        if args.ini_file:
            if args.verbose:
                print(
                    f'ArgumentParser: Read configuration from file "{args.ini_file}".'
                )
    ...
    if args.func == "parse_client":
        ...
        result = subprocess.run(
            [
                ...
                "{{.ID}}",
                "--filter",
                f"label=com.docker.swarm.service.name={PREFIX_STACK_NAME}_srv-client",
            ],
            capture_output=True,
            text=True,
        )
        ...
        cmd_str = (
            f"docker exec {random.choice(container_list)} ./{args.cmd} {arguments}"
        )
