...
1. 配置 NFS server
    ...
    mkdir -p /home/iocdock/NFS/IocDock-data
    mkdir -p /home/iocdock/NFS/registry-data

    $ sudo vi /etc/exports
    # /home/iocdock/NFS/IocDock-data 192.168.1.0/24(rw,sync,all_squash,no_subtree_check)
    # /home/iocdock/NFS/registry-data 192.168.1.0/24(rw,sync,all_squash,no_subtree_check)
